...
** پروژه Profilig روی برنچ main هست و پروژه BDD سناریو جذر تقسیم روی برنچ BDD-SQRT هست و پروژه BDD سناریو جمع بر روی برنچ BDD-ADD **
...
برای این مسئله هم کاملا مشابه قسمت قبل عمل کردیم. حال برای پاسخ به سه سوال پرسیده شده ابتدا کلاس مورد نظر را ران کردیم و نتایج زیر را مشاهده می‌کنیم: <br> <br> 
![image](https://github.com/user-attachments/assets/e1b7444e-57c4-43ad-b9c9-eac38f965bbd)
<br>
<br>
همانطور که مشاهده می‌کنید فقط تست سوم فیل شده است که در واقع همان منهای یک به علاوه‌ی شش مساوی است با پنج هست. علت فیل شدن این تست و بروز این مشکل این است که ورودی عددی منفی است. برای رفع این مشکل کمی توابع استپ‌ها را تغییر دادیم تا این ورودی را هم هندل کند. <br> <br>
پس از اصلاح توابع و ران کردن مجدد تست‌ها داریم: <br> <br>
![image](https://github.com/user-attachments/assets/280cabf1-1d0c-49bb-9dc6-45eeae2691ad)
<br>
همانطور که مشاهده می‌کنید حال تمامی تست‌ها به درستی پاس می‌شوند. <br>
